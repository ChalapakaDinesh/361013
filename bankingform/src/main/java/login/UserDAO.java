...
public class UserDAO {
    ...
    public boolean registerUser(UserDTO userDTO) throws SQLException {
      String query = "INSERT INTO userdata (name, phone_no, address, email, pass, confirm_pass) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    public boolean validateUser(String username, String password) throws SQLException {
        String loginQuery = "SELECT name userdata WHERE name=? AND pass=?";
